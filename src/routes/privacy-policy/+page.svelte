<div class="prose mx-auto p-4 max-w-screen-lg" id="en">
	...
	<ul>
		...
		<li>
			<p>
				<strong>Website</strong> refers to Career Chakra, accessible from
				<a href="https://www.careerchakra.com/" rel="external nofollow noopener" target="_blank"
					>https://www.careerchakra.com/</a
				>
			</p>
		</li>
		<li>
	...
	<ul>
		<li>By email: <a href="mailto:help@careerchakra.com">help@careerchakra.com</a></li>
	</ul>
</div>
