<footer class="text-gray-600 body-font">
	<div class="container mx-auto lg:px-20 md:px-10 px-5 py-8 flex items-center sm:flex-row flex-col">
		...
		<span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
			<a
				class="text-gray-500"
				href="https://www.facebook.com/careerchakraai?mibextid=LQQJ4d"
				target="_blank"
			>
				<svg
					fill="currentColor"
			...
			<a class="ml-3 text-gray-500" href="https://x.com/careerchakra_AI" target="_blank">
				<svg
					fill="currentColor"
					stroke-linecap="round"
					stroke-linejoin="round"
			...
			<a
				...
				href="https://www.instagram.com/career_chakra_ai/"
				target="_blank"
			>
				<svg
					fill="none"
