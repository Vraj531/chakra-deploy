<script lang="ts">
	...
	const handleSubmit = async (e: Event) => {
		...
		const modal = document.getElementById('guest-privacy-policy-modal') as HTMLDialogElement;
...
<dialog id="guest-privacy-policy-modal" class="modal modal-bottom sm:modal-middle">
