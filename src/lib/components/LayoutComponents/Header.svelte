...
<header class="text-gray-600 body-font bg-white">
	<div class="container mx-auto flex flex-wrap py-0 px-4 md:px-20 justify-between items-center">
		...
		<a
			href="/"
			class="flex lg:w-1/5 title-font font-medium items-center text-gray-900 lg:items-center lg:justify-center ml-6 md:ml-0"
		>
			...
			{#if !userData}
				...
				>
					...
					<svg
						...
						stroke-linejoin="round"
						stroke-width="2"
						class="w-4 h-4 ml-1 md:block hidden"
						viewBox="0 0 24 24"
					>
						<path d="M5 12h14M12 5l7 7-7 7"></path>
					</svg>
